...
def Open_Application():
  ...
  try:  
    print("\n we are inside Test_webapp_qualityuser_Master.py program/Open_Application() module")
...
def Login_Qualityuser():
  ...
  try:
    print("\n we are inside Test_webapp_qualityuser_Master.py program/Login_Qualityuser() module")
...
## start - searching reports based upon query
    print("\n we are inside Test_webapp_qualityuser_Master.py program/View_Patient_Report_by_Review_status() module")
...
def Manage_LabReports():
    print("\n we are inside Test_webapp_qualityuser_Master.py program/Manage_LabReports() module")
...
def Take_screen_shot(file_name):
    print("\n we are inside Test_webapp_qualityuser_Master.py program/Take_screen_shot(file_name) module")
...
def Zoylo_report():
    print("\n we are inside Test_webapp_qualityuser_Master.py program/Zoylo_report() module")
...
## uploading file   
    print("\n we are inside Test_webapp_qualityuser_Master.py program/Upload_Replacement_file() module")
...
def Add_New_Vmer_status():
  ...
  ## Enter Scan Id
    ...
    Scan_Id.send_keys("CLI01822@6@19220221342643418")
    sleep(2)
...
def Manage_MER_Mapping():
    ...
    sleep(1)
    Search_scan_Id()
    enter_scan_id("CLI01822@1@811202115592775730") ## existing scan id for reassignment of the doctor
    ...
    Search_scan_Id()
    enter_scan_id("CLI01822@1@911202114424314930")  ## new mer scan id for assigning new doctor
    search_given_scan_id()
    select_scan_id()
    select_doc_id_merMapping()
    Accept_doc_id_merMapping()
...
def enter_scanid_call_link():
    ...
    scan_id_calllink.send_keys("CLI01822@1@811202115483189239")  ## new scan id for creating mer call link
    sleep(1)
